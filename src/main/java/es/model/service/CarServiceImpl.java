...
public class CarServiceImpl implements CarService {
  ...
  @Override
  public Page<CarDTO> getAllCarWithFavourites(
      String userId,
      Pageable pageable,
      Double minPrice,
      Double maxPrice,
    ...
    Page<CarProjection> products =
        findProductsWithFavourites(userId, pageable, minPrice, maxPrice, minKm, maxKm, state);
  ...
  private Page<CarProjection> findProductsWithFavourites(
      String userId,
      Pageable pageable,
      Double minPrice,
      Double maxPrice,
      ...
      State state)
      throws NotFoundException {
    return carRepository.findCarsWithFavouritesByUserId(
        userId, minPrice, maxPrice, minKm, maxKm, state, pageable);
  }
}
