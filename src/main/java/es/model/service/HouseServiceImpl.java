...
public class HouseServiceImpl implements HouseService {
  ...
  public Page<HouseDTO> getAllHousesWithFavourites(
      String userId,
      Pageable pageable,
      Double minPrice,
      Double maxPrice,
    ...
    Page<HouseProjection> products =
        findProductsWithFavourites(userId, pageable, minPrice, maxPrice, minm2, maxm2, state);
    if (products.isEmpty()) {
  ...
  private Page<HouseProjection> findProductsWithFavourites(
      String userId,
      Pageable pageable,
      Double minPrice,
      Double maxPrice,
      ...
      State state)
      throws NotFoundException {
    return houseRepository.findHousesWithFavouritesByUserId(
        userId, minPrice, maxPrice, minm2, maxm2, state, pageable);
  }
}
